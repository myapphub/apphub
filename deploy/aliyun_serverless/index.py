...
import os, requests, shutil, oss2, logging

def handler(environ, start_response):
    logging.info(environ.get('fc.request_uri', ''))
    if os.environ.get('APPHUB_DEFAULT_SDATABASES_ENGINE', None) == 'django.db.backends.sqlite3':
    ...
    if os.environ.get('APPHUB_DEFAULT_SDATABASES_ENGINE', None) == 'django.db.backends.sqlite3' and environ.get('REQUEST_METHOD', '') != 'GET':
